...
//    Returns:
//
//      An integer representing the state of the described button or axis. If
//      "id" represents an analogue input (such as SNES_DEVICE_ID_MOUSE_X and
//      SNES_DEVICE_ID_SUPER_SCOPE_X), you should return a value between -32768
//      and 32767. If it represents a digital input such as
//      SNES_DEVICE_ID_JOYPAD_B or SNES_DEVICE_ID_MOUSE_LEFT), return 1 if the
//      button is pressed, and 0 otherwise.
